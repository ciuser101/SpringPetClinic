...
public class ValidatorTests {
    ...
    @Test
   	public void testShouldNotValidateWhenFirstNameEmpty26022() {
       	LocaleContextHolder.setLocale(Locale.ENGLISH);
           Person person = new Person();
           person.setFirstName("");
           person.setLastName("smith");
    ...
    @Test
   	public void testShouldNotValidateWhenFirstNameEmpty26023432() {
       	LocaleContextHolder.setLocale(Locale.ENGLISH);
           Person person = new Person();
           person.setFirstName("");
           person.setLastName("smith");
    ...
    @Test
   	public void testShouldNotValidateWhenFirstNameEmpty2622222() {
       	LocaleContextHolder.setLocale(Locale.ENGLISH);
           Person person = new Person();
           person.setFirstName("");
           person.setLastName("smith");
